...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="container" style="margin-top: 100px;">
            ...
            <form action="editdb.php" method="POST" style="margin-top: -110px;">
                <div id="left">
            ...
            <div style="margin-left: 965px;"><a href="own_ride.php"><button type="delete" name="delete" class="btn btn-primary" style="color:#FFF;margin-top: 45px;">Delete</button></a>
            </div>
        </form>
